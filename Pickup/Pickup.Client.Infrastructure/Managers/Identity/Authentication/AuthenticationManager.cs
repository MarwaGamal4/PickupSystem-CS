...
using Pickup.Client.Infrastructure.Authentication;
using Pickup.Client.Infrastructure.Extensions;
using Pickup.Client.Infrastructure.Routes;
...
namespace Pickup.Client.Infrastructure.Managers.Identity.Authentication
{
