...
using Pickup.Application.Helpers;
...
namespace Pickup.Infrastructure
{
            ...
            Task.Run(async () =>
            {
                ...
                if (superUserInDb == null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        await _roleManager.GeneratePermissionClaimByModule(adminRole, PermissionModules.ManagerDashboard);
                    }
