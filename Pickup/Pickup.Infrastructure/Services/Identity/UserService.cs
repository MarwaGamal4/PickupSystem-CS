...
namespace Pickup.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        public async Task<Result<List<UserResponse>>> GetAllExecptAdminAsync()
        {
            var managers = await _userManager.GetUsersInRoleAsync(RoleConstants.AdministratorRole);
            var users = await _userManager.Users.ToListAsync();
