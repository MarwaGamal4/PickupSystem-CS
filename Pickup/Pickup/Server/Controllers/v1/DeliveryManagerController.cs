...
namespace Pickup.Server.Controllers.v1
{
    ...
    {
        [HttpGet]
        public async Task<IActionResult> GetAll(int pageNumber, int pageSize, string searchString,DateTime? From , DateTime? To,string Branch , string Driver , int? CID,[FromQuery] int?[] Status)
        {
