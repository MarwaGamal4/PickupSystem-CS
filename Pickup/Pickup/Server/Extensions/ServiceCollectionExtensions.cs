...
using Pickup.Application.Interfaces.Services.Account;
using Pickup.Application.Interfaces.Services.Identity;
using Pickup.Application.Models.Identity;
using Pickup.Infrastructure;
using Pickup.Infrastructure.Contexts;
using Pickup.Infrastructure.Repositories;
using Pickup.Infrastructure.Services;
using Pickup.Infrastructure.Services.Identity;
using Pickup.Infrastructure.Shared.Services;
using Pickup.Server.Permission;
using Pickup.Server.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static void RegisterSwagger(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\Pickup.Server.xml", System.AppDomain.CurrentDomain.BaseDirectory));
